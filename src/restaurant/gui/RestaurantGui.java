...
public class RestaurantGui extends JFrame implements ActionListener{
	...
	private JCheckBox changeOrder = new JCheckBox();
	...
	public void updateInfoPanel(Object person){
		...
		if(person instanceof CustomerAgent){
			...
			changeOrder.setSelected(customer.getChangeOrder()); 
			infoLabel.setText(
			...
			stateCB.setText("Have Enough Inventory?");
			stateCB.setSelected(market.getEnoughInventory());
			stateCB.setEnabled(true);
			infoLabel.setText(
					"<html><pre>     Name: " + market.getName() + " </html>");
		}else if (person instanceof CookAgent) {
			CookAgent cook = (CookAgent) person;
			stateCB.setText("Wait before cooking?");
			stateCB.setSelected(cook.getWaiting());
			stateCB.setEnabled(true);
			infoLabel.setText(
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource() == stateCB){
			...
			if(currentPerson instanceof CustomerAgent){
				CustomerAgent c = (CustomerAgent) currentPerson;
				c.setChangeOrder(changeOrder.isSelected());
			}
		}
